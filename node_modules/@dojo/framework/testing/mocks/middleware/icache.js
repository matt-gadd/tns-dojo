(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../../core/vdom", "../../../core/middleware/icache", "../../../shim/Map"], factory);
    }
    ...
    function createICacheMock() {
        ...
        var factory = vdom_1.create({ destroy: vdom_1.destroy, invalidator: vdom_1.invalidator });
