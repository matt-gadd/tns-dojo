(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./support/assertRender", "./support/selector", "../../core/Registry", "../../core/vdom", "../../core/util"], factory);
    }
    ...
    function harness(renderFunc, options) {
        ...
        function _tryRender() {
            ...
            if (invalidated) {
                var _c = selector_1.decorateNodes(render), hasDeferredProperties = _c.hasDeferredProperties, nodes = _c.nodes;
                _runCompares(nodes);
