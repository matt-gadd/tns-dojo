import { WNode, DNode, VNode, MiddlewareResultFactory, DefaultMiddlewareResult } from '../../core/interfaces';
...
export declare function harness(renderFunc: () => WNode, options?: HarnessOptions): HarnessAPI;
export declare function harness(renderFunc: () => WNode, customComparator?: CustomComparator[]): HarnessAPI;
