 ...
 */
export declare type Command<T = any, P extends object = DefaultPayload> = SyncCommand<T, P> | ((request: CommandRequest<T, P>) => Promise<void | PatchOperation<T>[]>) | SyncCommandWithOps<T, P>;
/**
 ...
 */
export declare function createProcessFactoryWith(callbacks: ProcessCallback[]): <S, P extends object>(id: string, commands: (SyncCommand<S, P> | SyncCommandWithOps<S, P> | ((request: CommandRequest<S, P>) => Promise<void | PatchOperation<S, any>[]>) | Command<S, P>[])[], callback?: ProcessCallback<S, DefaultPayload> | undefined) => Process<S, P>;
