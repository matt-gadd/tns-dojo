import { DNode, WidgetMetaConstructor, WidgetBaseInterface, WidgetProperties, MetaBase, RenderResult } from './interfaces';
...
export declare class WidgetBase<P = WidgetProperties, C extends DNode = DNode> implements WidgetBaseInterface<P, C> {
     ...
     */
    __properties__: this['properties'] & WidgetProperties & {
        __children__?: DNode | (DNode | DNode[])[];
    };
    /**
     * children array
     */
