(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./../decorators/inject", "./../decorators/handleDecorator", "./../decorators/diffProperty", "../ThemeInjector"], factory);
    }
    ...
    function ThemedMixin(Base) {
        var Themed = /** @class */ (function (_super) {
            ...
            Themed.prototype.variant = function () {
            ...
            Themed.prototype._recalculateThemeClasses = function () {
                var _this = this;
                var _a = this.properties, _b = _a.theme, themeProp = _b === void 0 ? {} : _b, _c = _a.classes, classes = _c === void 0 ? {} : _c;
                var theme;
                if (ThemeInjector_1.isThemeWithVariant(themeProp)) {
                    theme = ThemeInjector_1.isThemeWithVariants(themeProp.theme) ? themeProp.theme.theme : themeProp.theme;
                }
                else {
                    theme = themeProp;
                }
            ...
            tslib_1.__decorate([
                diffProperty_1.diffProperty('theme'),
                diffProperty_1.diffProperty('extraClasses'),
                diffProperty_1.diffProperty('classes')
            ...
            Themed = tslib_1.__decorate([
                inject_1.inject({
                    ...
                    getProperties: function (theme, properties) {
                        if (!properties.theme) {
                            var payload = theme.get();
                            if (ThemeInjector_1.isThemeInjectorPayloadWithVariant(payload)) {
