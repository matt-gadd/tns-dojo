...
import { Constructor, InjectorFactory, InjectorItem, RegistryLabel, WidgetBaseConstructor, WidgetBaseInterface, ESMDefaultWidgetBase, WidgetBaseConstructorFunction, ESMDefaultWidgetBaseFunction, Callback, WNodeFactory, RenderResult, WidgetBaseTypes, DefaultChildrenWNodeFactory, OptionalWNodeFactory } from './interfaces';
export declare type RegistryItem = WidgetBaseConstructor | WNodeFactory<any> | DefaultChildrenWNodeFactory<any> | OptionalWNodeFactory<any> | Promise<WidgetBaseConstructor | WNodeFactory<any>> | WidgetBaseConstructorFunction | ESMDefaultWidgetBaseFunction;
/**
 * Widget base type
 */
...
export interface RegistryEventObject extends EventObject<RegistryLabel> {
    action: string;
    item: WNodeFactory<any> | DefaultChildrenWNodeFactory<any> | OptionalWNodeFactory<any> | WidgetBaseConstructor | InjectorItem;
}
/**
...
export declare function isWidgetFunction(item: any): item is Callback<any, any, any, RenderResult>;
export declare function isWNodeFactory<W extends WidgetBaseTypes>(node: any): node is WNodeFactory<W>;
export declare function isWidget<T extends WidgetBaseInterface = any>(item: any): item is Constructor<T> | Callback<any, any, any, RenderResult>;
