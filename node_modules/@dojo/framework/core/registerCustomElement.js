(function (factory) {
    ...
    function create(descriptor, WidgetConstructor) {
        ...
        return /** @class */ (function (_super) {
            ...
            class_1.prototype._readyCallback = function () {
                var _this = this;
                var domProperties = {};
                var _a = descriptor.properties, properties = _a === void 0 ? [] : _a, _b = descriptor.events, events = _b === void 0 ? [] : _b;
                ...
                var children = array_1.from(this.childNodes).filter(function (childNode) { return !vdom_1.isTextNode(childNode) || childNode.data.replace(/^\s+|\s+$/g, ''); });
                if (!this._childType) {
                ...
                var Wrapper = factory(function () { return w(WidgetConstructor, widgetProperties, renderChildren()); });
                var registry = registryFactory();
                var themeContext = registerThemeInjector(this._getVariant() ? { theme: this._getTheme(), variant: this._getVariant() } : this._getTheme(), registry);
                ...
                var r = vdom_1.renderer(function () { return w(Wrapper, {}); });
                this._renderer = r;
                r.mount({ domNode: this, merge: false, registry: registry });
                var root = this.children[0];
                if (root) {
                    var _c = global_1.default.getComputedStyle(root).display, display = _c === void 0 ? 'block' : _c;
    ...
    function register(WidgetConstructor) {
        var descriptor = WidgetConstructor.__customElementDescriptor;
        if (!descriptor) {
