...
export declare const createStoreMiddleware: <S = any>(initial?: ((store: Store<S>) => void) | undefined) => import("../interfaces").MiddlewareResultFactory<import("../interfaces").WidgetProperties, import("../interfaces").DNode<any>[], {
