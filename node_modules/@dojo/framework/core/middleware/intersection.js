(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../../shim/WeakMap", "../../shim/IntersectionObserver", "../vdom", "./icache"], factory);
    }
    ...
    var factory = vdom_1.create({ icache: icache_1.default, node: vdom_1.node, invalidator: vdom_1.invalidator, destroy: vdom_1.destroy });
    exports.intersection = factory(function (_a) {
        var _b = _a.middleware, icache = _b.icache, node = _b.node, invalidator = _b.invalidator, destroy = _b.destroy;
        var handles = [];
        destroy(function () {
            var handle;
